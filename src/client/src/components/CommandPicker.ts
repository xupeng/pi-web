...
export class CommandPicker extends LitElement {
  ...
  static override styles = css`
    ...
    modal-surface { --modal-surface-width: min(720px, calc(100vw - 40px)); --modal-surface-max-height: min(640px, calc(100vh - 40px)); --modal-surface-max-height: min(640px, calc(100dvh - 40px)); }
