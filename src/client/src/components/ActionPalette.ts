...
export class ActionPalette extends LitElement {
  ...
  static override styles = css`
    ...
    modal-surface { --palette-top: min(12dvh, 90px); --palette-bottom: max(20px, var(--pi-app-safe-area-bottom)); --modal-surface-place-items: start center; --modal-surface-backdrop-padding: var(--palette-top) 20px var(--palette-bottom); --modal-surface-max-height: min(640px, calc(100dvh - var(--palette-top) - var(--palette-bottom))); }
